...
import 'package:ta_mobile/app/modules/LandingPage/views/responsive_layout.dart';

import 'package:ta_mobile/app/modules/auth/controllers/auth_controller.dart';
import 'package:ta_mobile/app/modules/auth/views/mobile_screen.dart';
import 'package:ta_mobile/app/modules/auth/views/web_screen.dart';
...
class AuthView extends GetView<AuthController> {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      mobileScreen: MobileScreenAuth(), 
      webScreen: WebScreenAuth());
    // return Scaffold(
